    ...
    <div v-if="control" id="whatsapp-chat">
      <div class="whatsapp-chat-header">
        <div class="whatsapp-chat-avatar">
          <img src="@/assets/WhasApp.png" alt="companyName + ' ' + 'Logo'" />
        </div>
        <p class="whatsapp-chat-name-block">
          <span class="whatsapp-chat-name">{{ companyName }}</span><br /><small>{{ textReply }}</small>
        </p>
      </div>
      ...
      <a class="close-chat" @click="control = false">x</a>
    </div>
    <button class="blantershow-chat" title="Start Chat" @click="control = !control">
