            ...
            <div class="grid md:grid-cols-2 gap-10">
                ...
                <label class="block mb-8">
                    <div class="flex items-center">
                        <span>
                            <input type="checkbox" class="my-2 border-sky-700 border-2 focus:ring-sky-700" required
                                v-model="register.gdpr" autocomplete="off"><span class="mx-2"></span>
                        </span>
                        <div>By ticking the box you consent your data will be used by DoctorToday for the purpose of your
                            own medical treatment</div>
                    </div>
                </label>
            </div>
            <div class="g-recaptcha" data-sitekey="6Lflp-QkAAAAAKQG3R5haTduQf9GwGtGhrZ3wd3M" data-callback="enableButton">
            <!-- <div class="g-recaptcha" data-sitekey="6Lc-NnskAAAAAEIXjaR8lUD6m8HKSo2MHAGCPYyw" data-callback="enableButton">local -->
            </div>
