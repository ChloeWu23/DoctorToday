    ...
    <div class="xl:max-w-screen-xl mx-auto" id="pageContent">
        <div class="flex justify-center items-center">
            <div
                ...
                <div
                    class="opacity-0 sm:opacity-100 flex justify-center md:text-[60px] text-3xl text-sky-700 font-extrabold rounded-3xl bg-opacity-80 md:py-20 py-10">
                    Meet Our Team
                </div>
            </div>
        </div>
                            ...
                            <div class="w-full py-3">
                                <div class="h-full py-2 shadow-md w-full flex items-center justify-center overflow-hidden">
                                    <img style="object-position: 55% 20%;"
                                        class="pb-3 drop-shadow-xl w-[210px] h-[290px] object-none"
        ...
        DataPeople.get()
            .then(res => {
                ...
                for (let i = 0; i < this.peopleList.length; i++) {
                    ...
                    // this.peopleList[i].image = require('../assets/people/' + i + '.png');
                    //getImageUrl(this.peopleList[i].image, this.peopleList[i])
                }
            })
            .catch(err => {
