        ...
        <div class="submit-form">
            <div class="block">
                ...
                <input type="text" class="mt-0
                        ...
                        focus:ring-0 focus:border-black" required v-model="username" name="username" />
            </div>
            ...
            <div class="block">
                ...
                <input type="password" class="mt-0
                        ...
                        px-0.5
                        border-0 border-b-2 border-sky-700
                        focus:ring-0 focus:border-black" v-model="password" name="password" />
            </div>

            <button @click="login" class="mt-8 p-2 bg-sky-700 text-center rounded-lg text-white border-white">
                Submit
            </button>
            <p v-if="msg">{{ msg }}</p>
        </div>
