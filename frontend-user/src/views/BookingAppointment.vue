<template>
    ...
    <div>
        <h1 class = "text-gray-700 font-bold text-lg">Booking Requests<br></h1>
        <p class = "text-sm">Appointments can be requested online via our online booking system. 
        You will need to wait for one of our friendly staff to email you back with a confimation before your appoitnment is booked.</p>
        <b class = "text-sm">Please check your junk mail for confirmation emails.</b>
        <div><br></div>
        <div class = "text-sm">
        ...
        <div><b><br></b></div>
        <h1 class = "text-gray-700  font-bold text-lg">Walk-in Appointments</h1>
        <p class="text-sm">Our walk in service is <b>temporarily suspended</b> due to 
         ...
         <div><b><br></b></div>
        <h1 class = "text-gray-700  font-bold text-lg">Family members, friends and chaperones</h1>
        <p class="text-sm">Patients are welcome to attend with a family member or friend. At your specific request, 
        ...
        <div><b><br></b></div>
        <h1 class = "text-gray-700  font-bold text-lg">Children</h1>
        <p class = "text-sm">Please note that children under 16 years of age will not be seen unless accompanied by a 
