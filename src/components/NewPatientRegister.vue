        ...
        <form class="mx-6 md:mx-20 min-w-fit">
            <div class="grid md:grid-cols-2 gap-10">
                ...
                <label class="block">
                    <span>Home Tel</span>
                    <input type="text" class="w-full border-0 border-b-2 border-sky-700 focus:ring-0 focus:border-black"
                        required v-model="register.homeTel" placeholder="" autocomplete="off">
                </label>
                <label class="block">
                    <span>Mobile</span>
                    <input type="text" class="w-full border-0 border-b-2 border-sky-700 focus:ring-0 focus:border-black"
                ...
                <label class="block">
                    <span>Fax</span>
                    <input type="text" class="w-full border-0 border-b-2 border-sky-700 focus:ring-0 focus:border-black"
                        required v-model="register.fax" placeholder="" autocomplete="off">
                </label>
                <label class="block">
    ...
    data() {
        return {
            register: {
                ...
                mobile: '',
                fax: '',
                media: [{ medium: "Google", flag: '' }, { medium: "Yahoo", flag: '' }, { medium: "Other Search Engines", flag: '' }, { medium: "Word of Mouth", flag: '' }, { medium: "Walked By", flag: '' }, { medium: "Other", flag: '' }],
                comms: [{ comm: "Phone", flag: '' }, { comm: "Email", flag: '' }, { comm: "Fax", flag: '' }, { comm: "Post", flag: '' }],
                notes: ''
            }
        }
    }
